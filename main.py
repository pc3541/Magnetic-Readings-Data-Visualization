...
time_start1 = st.sidebar.text_input("Desired time segment start (HHMMSS):", value="000001")
time_end1 = st.sidebar.text_input("Desired time segment end (HHMMSS):", value="235959")
